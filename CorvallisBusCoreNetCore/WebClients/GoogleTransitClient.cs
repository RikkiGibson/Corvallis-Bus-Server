...
using CorvallisBusCoreNetCore.Models.GoogleTransit;
using CorvallisBusCoreNetCore.Util;
using System;
...
namespace CorvallisBusCoreNetCore.WebClients
{
    ...
    {
        public static AsyncLazy<Tuple<List<GoogleRoute>, List<GoogleRouteSchedule>>> GoogleRoutes =
            new AsyncLazy<Tuple<List<GoogleRoute>, List<GoogleRouteSchedule>>>(() => DoTask());
        ...
        /// </summary>
        private static async Task<Stream> GetZipFileAsync()
        {
